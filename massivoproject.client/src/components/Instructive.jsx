  ...
  return (
    <Container maxWidth="lg" sx={{ py: 6 }}>
      <Box sx={{ mb: 4, textAlign: 'center' }}>
        ...
        <Divider sx={{ mt: 3, mb: 4, width: '80px', mx: 'auto', borderWidth: 3, borderColor: '#139AA0' }} />
      </Box>
      ...
      <Grid container spacing={3} sx={{ mb: 6 }}>
          ...
          >
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
              ...
              <Typography variant="body2" color="text.secondary">
                Encuentra vehículos disponibles para el evento que deseas asistir.
              </Typography>
            </Box>
          </Paper>
        </Grid>
        ...
        <Grid item xs={12} md={4}>
          ...
          >
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
              <DirectionsCarIcon sx={{ fontSize: 50, color: '#139AA0', mb: 2 }} />
              <Typography variant="h5" fontWeight="bold" gutterBottom>
                Ofrece tu vehículo
              </Typography>
              <Typography variant="body2" color="text.secondary">
        ...
        <Grid item xs={12} md={4}>
          ...
          >
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
              ...
              <Typography variant="body2" color="text.secondary">
                Crea y gestiona eventos para que otros usuarios reserven vehículos.
              </Typography>
            </Box>
          </Paper>
        </Grid>
