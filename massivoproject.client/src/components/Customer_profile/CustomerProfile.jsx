...
const CustomerProfile = () => {
    ...
    // Fixed handleSave function in CustomerProfile.jsx
    const handleSave = async () => {
        try {
            ...
            if (selectedFile) {
                try {
                    // Pass the file and entityType to uploadFile
            ...
            const payload = {
                ...
                // Always include ProfileImage, use existing one if no new file
                ProfileImage: profileImageUrl || userData.profileImage || null,
            };
