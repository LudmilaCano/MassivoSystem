                ...
                <Grid item xs={12}>
                    ...
                    >
                        ...
                        >
                            ...
                            <Chip
                                label={
                                    eventVehicle.capacity < 2
                                        ? `${eventVehicle.capacity} lugar disponible`
                                        : `${eventVehicle.capacity} lugares disponibles`
                                }
                                color={eventVehicle.capacity < 2 ? "error" : "success"}
                                sx={{ mb: 2 }}
                            />
                        </Box>
                        ...
                        <Box sx={{ flex: 1, width: "100%" }}>
                            ...
                            >
                                ...
                                <Button
                                    ...
                                    color="warning"
                                    size="large"
                                    disabled={eventVehicle.vehicle.capacity - eventVehicle.occupation === 0}
                                    sx={{
                                        minWidth: 180,
                                        py: 1.5,
                                        fontSize: "1.1rem",
                                ...
                                >
                                    {eventVehicle.vehicle.Capacity - eventVehicle.Occupation === 0
