                            ...
                            <Box sx={{
                                ...
                                <Box sx={{ textAlign: { xs: "left", sm: "center" } }}>
                                    <Box sx={{
                                        ...
                                        <LocationOnIcon sx={{ color: "#1976d2", mr: 1 }} fontSize="small" />
                                    ...
                                    <Box sx={{
                                        ...
                                        <AccessTimeIcon sx={{ color: "#757575", mr: 0.5 }} fontSize="small" />
                                        <Typography variant="body2" color="text.secondary">
                                            {new Date(eventVehicle.date).toLocaleDateString('es-ES')} - {new Date(eventVehicle.date).toLocaleTimeString('es-ES', { hour: '2-digit', minute: '2-digit' })}
                                        </Typography>
                                    </Box>
                                </Box>
                                ...
                                <Box sx={{ textAlign: { xs: "left", sm: "center" } }}>
                                    <Box sx={{
                                        ...
                                        <FlagIcon sx={{ color: "#d32f2f", mr: 1 }} fontSize="small" />
                                        <Typography variant="subtitle2" color="text.secondary" sx={{ fontWeight: "bold" }}>
                                            LLEGADA
                                        </Typography>
                                    </Box>
                                    ...
                                    <Box sx={{
                                        ...
                                        <DriveEtaIcon sx={{ color: "#388e3c", mr: 0.5 }} fontSize="small" />
                                        <Typography variant="body2" color="text.secondary">
