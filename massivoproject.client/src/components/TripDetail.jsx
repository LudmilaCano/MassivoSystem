          ...
          >
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 0.5 }}>
              <Typography variant="body2">
                <LocationOnIcon
                  sx={{ verticalAlign: "middle", color: "#1976d2", mr: 0.5 }}
                  fontSize="small"
                />
                <b>Salida:</b> {eventVehicle.from} -{" "}
                <AccessTimeIcon
                  sx={{ verticalAlign: "middle", color: "#757575", mx: 0.5 }}
                  fontSize="small"
                />
                <b>Horario:</b> {eventVehicle.date}
              </Typography>
              <Typography variant="body2">
                <FlagIcon
                  sx={{ verticalAlign: "middle", color: "#d32f2f", mr: 0.5 }}
                  fontSize="small"
                />
              ...
              <Typography variant="body2">
                <DriveEtaIcon
                  sx={{ verticalAlign: "middle", color: "#388e3c", mr: 0.5 }}
                  fontSize="small"
                />
