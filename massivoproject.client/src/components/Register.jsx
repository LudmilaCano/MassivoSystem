...
const Register = () => {
    ...
    const validateForm = () => {
        ...
        if (!nameSurnameRegex.test(formData.apellido) && formData.apellido) {
            newErrors.apellido =
                "El apellido solo puede contener letras, espacios y acentos";
        }
        ...
        if (!formData.password) {
            ...
            // Suponiendo que la contraseña debe tener al menos 6 caracteres
    ...
    const handleSubmit = async () => {
        ...
        if (validateForm()) {
            const formattedData = {
                ...
                profileImage: profileImageUrl || "https://picsum.photos/200/300",
            };
            ...
            try {
                ...
                showAlert("¡Algo salió mal, por favor intenta nuevamente!", "error");
            } finally {
                setLoading(false);
            }
        };
                ...
                <Grid item xs={12} md={7} component={Paper} elevation={6} square>
                    ...
                    >
                            ...
                            >
                                ...
                                {sortedProvinces.map((provincia) => (
                                    <MenuItem key={provincia.id} value={provincia.id}>
                                        {" "}
                                        {/* Usamos provincia.id como valor */}
                                        {provincia.name}
                                    </MenuItem>
                                ))}
                                {/* ------------------------------------------------------------ */}
                        ...
                        <Typography variant="body2" sx={{ mt: 1 }}>
                            ¿Ya tenés una cuenta?{" "}
                            <Link href="/login" sx={{ color: "#139AA0" }}>
                                INICIAR SESIÓN
                            </Link>
                        </Typography>
                    </Box>
